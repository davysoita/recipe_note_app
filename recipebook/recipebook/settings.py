...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-k%c44c!n(zz3c@)%zt9sbj2#u46d4rs3mzq(-e_24ttm-j1^af')
...
elif all(os.environ.get(var) for var in ['DB_NAME', 'DB_USER', 'DB_PASSWORD']):
    DATABASES = {
        'default': {
